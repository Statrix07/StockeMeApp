...
<body>
  <center>
      <h1>Vorratsspeicher</h1>
      <h2>Produkt hinzufügen</h2>

      <form action="vorrateinfuegen.php" method="post">
        ...
        <p>
            <fieldset style = "width: 120px; margin:  0px auto;">
            <label for="Mindestmenge">Mindestmenge:</label>
            <input type="text" name="Mindestmenge" id="Mindestmenge">
            </fieldset>
        </p>
      ...
      $sqlget = "SELECT * FROM vorrat";
      $sqldata = mysqli_query($conn, $sqlget) or die("Error");

?>
      <table style="background-color:#ffffff;>"
<?php
      echo "<tr><th>Produktname</th><th>Produktkategorie</th><th>Menge</th><th>Mindestmenge</th><th>Ablaufdatum</th><th>Lagerort</th></tr>";
      ...
      while ($row = mysqli_fetch_array($sqldata)) { //MYSQLI_ASSOC
        ...
        echo $row['Menge'];
        echo "</td><td>";
        echo $row['Mindestmenge'];
        echo "</td><td>";
        echo $row['Ablaufdatum'];
        echo "</td><td>";
        echo $row['Lagerort']; ?>
        <td><input type="button" value="verbraucht"></td> <?php
        echo "</td></tr>";
      }
