...
<center>
        ...
        $Lagerort = $_REQUEST['Lagerort'];

        // Performing insert query execution
        $sql = "INSERT INTO vorrat VALUES ('$Produktname','$Produktkategorie','$Menge','$Ablaufdatum','$Lagerort')";
...
<script type="text/javascript">
  window.setTimeout('location.href="vorrat.php"', 2500);
</script>
