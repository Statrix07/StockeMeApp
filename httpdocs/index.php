...
<body>
  ...
  <center>
    <br><br><br>
    <img src="Alien.jpg" width="500" height="500" style="transform:rotate(180deg);">
    <p style="font-size: 60px; font-weight: bold; font-family: 'Montserrat', sans-serif; -webkit-text-fill-color:pink; -webkit-text-stroke:2px black;">Willkommen bei StockMe</p>
  </center>
