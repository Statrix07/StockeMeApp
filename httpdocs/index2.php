...
<body>
  ...
  <center>
    ...
    <p style="font-size: 60px; font-weight: bold; font-family: 'Montserrat', sans-serif; -webkit-text-fill-color:pink; -webkit-text-stroke:2px black;">Willkommen zurück.</p>
  </center>
